          ...
          PointerIn a,  SizeType const*const wa)
{
	...
	if(c == nullptr || a == nullptr)
		throw std::length_error("Status in boost::numeric::ublas::copy: Pointers shall not be null pointers.");
               ...
               UnaryOp op)
{
	...
	if(c == nullptr || a == nullptr)
		throw std::length_error("Status in boost::numeric::ublas::transform: Pointers shall not be null pointers.");
            ...
            PointerIn a,       SizeType const*const wa)
{
	...
	if(c == nullptr || a == nullptr)
		throw std::runtime_error("Status in boost::numeric::ublas::trans: Pointers shall not be null pointers.");

	if(na == nullptr)
		throw std::runtime_error("Status in boost::numeric::ublas::trans: Pointers shall not be null.");

	if(wc == nullptr || wa == nullptr)
		throw std::length_error("Status in boost::numeric::ublas::trans: Pointers shall not be null pointers.");
